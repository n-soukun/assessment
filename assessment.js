...
const resultContainerDivision = document.getElementById("result-container");
const resultDivision = document.getElementById("result-area");
const xDivision = document.getElementById("x-area");
...
assessmentButton.addEventListener("click", () => {
  ...
  resultContainerDivision.classList.add("show");
});
